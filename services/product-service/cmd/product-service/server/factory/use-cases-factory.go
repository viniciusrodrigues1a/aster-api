...
func makeAddProductQuantityUseCase() *usecase.AddProductQuantityUseCase {
	return usecase.NewAddProductQuantityUseCase(stateEmitter, eventStoreRepository, stateStoreRepository, stateStoreRepository)
}
