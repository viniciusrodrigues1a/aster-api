...
func MakeAddProductToInventoryUseCase() *usecase.AddProductToInventoryUseCase {
	return usecase.NewAddProductToInventoryUseCase(eventStoreRepository, stateStoreRepository, stateStoreRepository)
}
